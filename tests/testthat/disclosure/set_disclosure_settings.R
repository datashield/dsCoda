...
set.non_permissive.disclosure.settings <- function() {
    options(datashield.privacyLevel = "5")
...
set.permissive.disclosure.settings <- function() {
    options(datashield.privacyLevel = "5")
    options(default.datashield.privacyControlLevel = "permissive")
    options(default.nfilter.glm = "0.33")
    options(default.nfilter.kNN = "3")
...
set.avocado.disclosure.settings <- function() {
    options(datashield.privacyLevel = "5")
    options(default.datashield.privacyControlLevel = "avocade")
    options(default.nfilter.glm = "0.33")
    options(default.nfilter.kNN = "3")
    options(default.nfilter.string = "80")
    options(default.nfilter.subset = "3")
...
set.banana.disclosure.settings <- function() {
    options(datashield.privacyLevel = "5")
    options(default.datashield.privacyControlLevel = "banana")
    options(default.nfilter.glm = "0.33")
    options(default.nfilter.kNN = "3")
    options(default.nfilter.string = "80")
    options(default.nfilter.subset = "3")
